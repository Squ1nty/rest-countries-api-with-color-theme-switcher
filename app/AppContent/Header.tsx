...
export default function Header(){
  ...
  return(
  <header className={`w-full sticky top-0 flex items-center justify-center px-4 py-6 shadow-md ${theme === 'dark' ? 'bg-[var(--blue-900)] text-white' : 'bg-white text-[var(--blue-950)]'} z-10 `}>
    <span className="w-full max-w-[1440px] flex items-center justify-between">
